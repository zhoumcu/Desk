...
public class RightListAdapter extends RecyclerView.Adapter<RightListAdapter.ViewHolder> {
    ...
    public RightListAdapter(Context context, List<String> mOrder) {
        this.mOrder = mOrder;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mLayoutInflater.inflate(R.layout.item_options_right, parent, false);
    ...
    private void bindEvent(final int position, RightListAdapter.ViewHolder holder) {
    ...
    private void fillValue(int position, RightListAdapter.ViewHolder viewHolder) {
